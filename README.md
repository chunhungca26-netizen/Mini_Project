...
7.  Cấu trúc mã nguồn (Modular Design)
...
8. Các hàm chính trong chương trình
...
10. Tính năng nâng cao đã triển khai
...
11. Kiểm tra dữ liệu (Validation)
...
12.  Cách khởi chạy chương trình
    
...
14.  Các tính năng nâng cao (Advanced Features)
...
15.  Quá trình làm việc (Workflow & Git)
...
16. TỰ ĐÁNH GIÁ THEO THANG ĐIỂM : 10 điểm
